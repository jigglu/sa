...
export const NavBar: FC = () => {
  ...
  return (
    <FixedContainer>
      <Nav>
        <Link to="/" title="sCristr">
          <LogoImg stable={visible ? 1 : 0} />
        </Link>
        <ul>
          <li>
            <ExternalLink href="https://github.com/scristr">Code</ExternalLink>
          </li>
          <li>
            <ExternalLink href="https://docs.scristr.org">Docs</ExternalLink>
          </li>
          <Link to="/governance-token-meta" title="sCristr (CTA)">
            Meta
          </Link>
          <li>
            <AppLink href="https://scristr.app">
