...
export const About: FC = () => {
  return (
    <FullBleed dark={false}>
      <Section h3="sCristr combines lending income with trading fees to produce higher yielding assets.">
        <Grid>
          ...
          <Item
            ...
            description={
              <>
                All contributors can earn <Link to="/governance-token-meta">CTA</Link> in sCristr's native liquidity pools
              </>
            }
          />
